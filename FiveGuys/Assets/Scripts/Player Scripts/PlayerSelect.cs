...
public class PlayerSelect : MonoBehaviour
{
    ...
    public void SelectPlayerOne()
    {
        ...
        GameObject.Find("Player(Clone)").GetComponent<PlayerScript>().baseSpeed = 7;
    }

    public void SelectPlayerTwo()
    {
        GameObject.Find("Player(Clone)").GetComponent<PlayerScript>().maxLives = 1;
        GameObject.Find("Player(Clone)").GetComponent<PlayerScript>().baseSpeed = 10;
    ...
    public void SelectPlayerThree()
    {
        ...
        GameObject.Find("Player(Clone)").GetComponent<PlayerScript>().baseSpeed = 5;
    }
}
