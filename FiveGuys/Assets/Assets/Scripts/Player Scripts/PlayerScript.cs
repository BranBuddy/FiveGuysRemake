...
public class PlayerScript : MonoBehaviour
{
   ...
   private float verticalInput;
    ...
    internal PlayerSelect playerSelect;
    ...
    {
        if (GameObject.Find("GameManager").GetComponent<PlayerSelect>().whatCharacterAmI == 0)
        {
            speed = 7;
            maxLives = 3;
        }
        if (GameObject.Find("GameManager").GetComponent<PlayerSelect>().whatCharacterAmI == 1)
        {
            speed = 10;
            maxLives = 1;

        }
        if (GameObject.Find("GameManager").GetComponent<PlayerSelect>().whatCharacterAmI == 2)
        {
            speed = 5;
            maxLives = 5;
        }
